...
export default function SettingsScreen() {
  ...
  const analyzeImageQuality = async (imageAsset: ImagePickerAsset): Promise<'good' | 'poor'> => {
    ...
    const hasGoodFileSize = !imageAsset.fileSize || imageAsset.fileSize > 100000;
      ...
      if (response.ok && data.success) {
        ...
        const updatedProfile = {
          ...
          profile: {
            ...
            address: data.profile?.address || editAddress,
            email: data.profile?.email || editEmail,
            zone: data.profile?.zone || editZone,
          }
        };
  ...
  const menuOptions = [
    ...
    },
    {
      ...
      onPress: () => setIsMessagingModalVisible(true),
    },
    {
      id: 'about',
      label: 'À propos',
  ...
  return (
    <View style={[styles.container, isDarkMode ? styles.darkContainer : styles.lightContainer, { flex: 1 }]}>
            ...
            <View style={styles.profileModalContent}>
              ...
              {isEditingProfile ? (
                <View style={styles.profileInfoModal}>
                  ...
                  <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, isDarkMode ? styles.darkText : styles.lightText]}>Zone</Text>
                    <TextInput
                      style={[styles.input, isDarkMode ? styles.darkInput : styles.lightInput]}
                      value={editZone}
      ...
      <HelpSupportModal
        ...
        onClose={() => setIsMessagingModalVisible(false)}
